...
| SLO trend | Observe dashboard/alerts for request error rate and p95 latency | Error rate <= 1.0% and p95 latency <= 500 ms for the entire phase window. |
...
- Error rate exceeds 2.0% for 5 consecutive minutes.
