...
- [x] Task 2: Migrate the highest-fanout field resolvers to dataloader-backed fetches
- [x] Task 3: Tighten remaining direct lookups and verify Relay/auth behavior
