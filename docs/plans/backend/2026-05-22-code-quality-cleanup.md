...
Status: `GQL-005` Stage 8 complete; `DOC-001` Stage 8 complete
Owner lane: backend
...
- `GQL-001`, `GQL-002`, `GQL-003`, `GQL-004`, `GQL-006`, `GQL-007`, `ECTO-001`, and `CTX-001`: Stage 1 complete, Stage 2 complete, Stage 3 complete, Stage 7 complete, Stage 8 not started.
