...
Status: `GQL-001` Stage 8 complete; `GQL-002` Stage 8 complete; `GQL-003` Stage 8 complete; `GQL-004` Stage 8 complete; `GQL-005` Stage 8 complete; `SOCK-002` Stage 8 complete; `DOC-001` Stage 8 complete
Owner lane: backend
...
- `GQL-006`, `GQL-007`, `ECTO-001`, and `CTX-001`: Stage 1 complete, Stage 2 complete, Stage 3 complete, Stage 7 complete, Stage 8 not started.
...
Current status: Stage 1 and Stage 2 are complete for all user-reported issues. Stage 3 and Stage 7 are complete for `GQL-001`, `GQL-002`, `GQL-003`, `GQL-004`, `GQL-005`, `GQL-006`, `GQL-007`, `ECTO-001`, `CTX-001`, `SOCK-002`, `SOCK-003`, `LIVE-001`, and `DOC-001`. Stage 4 is complete. Stage 5 and Stage 6 are complete for `GQL-008`, `GEN-002`, `WEB-001`, and `GQL-009`. Stage 7 plans are written for `GQL-008`, `GEN-002`, and `WEB-001`; `GQL-009` remains deferred until narrower cleanup work is planned or fixed. Stage 8 is complete for `GQL-004`.
