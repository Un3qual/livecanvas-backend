...
- Stage 3: Dedicated chat timeline/event-object redesign explicitly started on 2026-05-31; design is locked in `docs/plans/backend/2026-05-31-gen-001-chat-timeline-event-redesign.md`, and implementation remains blocked until an executable implementation plan is written and approved.
- Stage 4: Complete as the global agent-led scan; no per-issue action pending.
- Stage 5: Not applicable; this is a user-reported issue.
- Stage 6: Not applicable; this is a user-reported issue.
