...
- `GEN-001`: Stage 1 complete, Stage 2 complete with a deferred-valid decision; dedicated redesign is explicitly started, design is locked, and the executable implementation plan is written; Stage 8 remains blocked until the written plan is approved and implementation is explicitly requested.
...
- Stage 3: Dedicated chat timeline/event-object redesign explicitly started on 2026-05-31; design is locked in `docs/plans/backend/2026-05-31-gen-001-chat-timeline-event-redesign.md`, and the executable implementation plan is written in `docs/plans/backend/2026-05-31-gen-001-chat-timeline-event-implementation-plan.md`.
- Stage 4: Complete as the global agent-led scan; no per-issue action pending.
- Stage 5: Not applicable; this is a user-reported issue.
- Stage 6: Not applicable; this is a user-reported issue.
- Stage 7: Active in the dedicated redesign plan at `docs/plans/backend/2026-05-31-gen-001-chat-timeline-event-redesign.md`.
- Stage 8: Blocked until the written implementation plan is approved and implementation is explicitly requested.
