...
- Batch: `GQL-005` Stage 8 complete; awaiting the next explicit issue selection
...
- Current status:
  ...
  - `GQL-001`, `GQL-002`, `GQL-003`, `GQL-004`, `GQL-006`, `GQL-007`, `ECTO-001`, and `CTX-001`: Stage 2, Stage 3, and Stage 7 complete; Stage 8 not started.
