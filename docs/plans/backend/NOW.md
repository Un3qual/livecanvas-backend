...
- Batch: `GQL-009` Stage 8 Task 3 user/profile/identity resolver extraction
...
- Current status:
  ...
  - `GQL-009`: Stage 7 complete; Stage 8 Task 1 contact resolver extraction complete; Stage 8 Task 2 data-governance resolver extraction complete; Stage 8 Task 3 user/profile/identity resolver extraction is next.
...
- Execute `GQL-009` Stage 8 Task 3 by extracting viewer, private user email, profile child connections, user identity fields, profile/privacy mutations, and identity unlinking into a focused user/profile/identity resolver. Preserve the public GraphQL contract and use TDD for production-code refactors.
...
- Continue with `GQL-009` Stage 8 Task 3: user/profile/identity resolver extraction.
