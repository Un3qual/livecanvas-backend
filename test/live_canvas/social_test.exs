defmodule LC.SocialTest do
  ...
  describe "directional block privacy" do
    ...
    test "reject_users_blocking_viewer/2 preserves visible-user order" do
      viewer = user_fixture()
      ...
      assert Social.reject_users_blocking_viewer(viewer, [visible_first, hidden, visible_last]) ==
