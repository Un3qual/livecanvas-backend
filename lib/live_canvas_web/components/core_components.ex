defmodule LCWeb.CoreComponents do
  ...
  @type js_command :: %JS{}
  @type translation_error :: {String.t(), Keyword.t()}
  ...
  @spec show(String.t()) :: js_command()
  def show(selector) when is_binary(selector) do
    JS.show(
      to: selector,
      time: 300,
      transition:
  ...
  @spec show(js_command(), String.t()) :: js_command()
  ...
  @spec hide(String.t()) :: js_command()
  def hide(selector) when is_binary(selector) do
    JS.hide(
      to: selector,
      time: 200,
      transition:
  ...
  @spec hide(js_command(), String.t()) :: js_command()
  ...
  """
  @spec translate_error(translation_error()) :: String.t()
  ...
  """
  @spec translate_errors(keyword(translation_error()), atom()) :: [String.t()]
